...
public class EletricBassBuilder implements IEletricStringInstrumentsBuilder {
	...
	public EletricBass getresult() {
		return new EletricBass(type, strings, pickups, color, shape);
	}
